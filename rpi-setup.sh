...
PACKAGES_ALL="ntp ntpdate python3-thonny scratch2 lxterminal leafpad python3-pip vlc qt4-designer python3-pyqt4 qt4-dev-tools dia-gnome mono-complete mu gnome-screenshot pix-icons pix-plym-splash rpd-wallpaper rpi-chromium-mods python-sense-emu-doc python3-pip lxterminal graphicsmagick fritzing qtcreator qt5-default pyqt5-dev pyqt5-dev-tools"
